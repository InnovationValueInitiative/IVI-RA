...
p0 <- vector(mode = "list", length(therapy.snames))
names(p0) <- therapy.snames 
p0[["cdmards"]] <- c(0.298, 0.123, 0.042)
p0[["abtivmtx"]] <- c(0.573, 0.328, 0.156)
p0[["adamtx"]] <- c(0.615, 0.368, 0.183)
p0[["ada"]] <- c(0.499, 0.264, 0.115)
p0[["tt"]] <- c(0.503, 0.266, 0.117)
p0[["etnmtx"]] <- c(0.713, 0.472, 0.263)
p0[["etn"]] <- c(0.645, 0.398, 0.205)
p0[["golmtx"]] <- c(0.642, 0.395, 0.202)
p0[["ifxmtx"]] <- c(0.595, 0.348, 0.169)
p0[["placebo"]] <- c(0.175, 0.059, 0.016)
p0[["tczmtx"]] <- c(0.706, 0.464, 0.256)
p0[["tcz"]] <- c(0.717, 0.477, 0.266)
p0[["czpmtx"]] <- c(0.564, 0.319, 0.150)
p0[["abtscmtx"]] <- c(0.638, 0.391, 0.199)
p0[["nbt"]] <- c(0, 0, 0)
p0[["rtxmtx"]] <- c(0.573, 0.328, 0.156) # assumed to be same as abt iv
p0[["tofmtx"]] <- c(NA, NA, NA)
p0[["rtx"]] <- c(NA, NA, NA)
p0[["tof"]] <- c(NA, NA, NA)
p0[["czp"]] <- c(NA, NA, NA)
p0[["gol"]] <- c(NA, NA, NA)
...
### Store Results
nice_acr_nma <- list(p = p, nobs = nobs)
...
therapy.pars <- list(info = therapy.info,
                icon_acr_nma = icon_acr_nma,
                icon_acr_nma_naive = icon_acr_nma_naive,
                icon_acr_nma_exp = icon_acr_nma_exp,
                nice_acr_nma = nice_acr_nma,
