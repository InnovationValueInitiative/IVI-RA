...
surv.b.g <- read.csv("duration-bsrbr-eular-good-ggamma.csv")
risk.b.g <- read.csv("duration-bsrbr-eular-good-risk.csv")
surv.b.m <- read.csv("duration-bsrbr-eular-moderate-ggamma.csv")
risk.b.m <- read.csv("duration-bsrbr-eular-moderate-risk.csv")
surv.c <- read.csv("duration-corrona-allpat.csv")
risk.c <- read.csv("duration-corrona-allpat-risk.csv")
...
ggsave("figs/duration-bsrbr-ipdsurv-eular-moderate-km.pdf",
...
ggsave("figs/duration-bsrbr-ipdsurv-eular-good-km.pdf",
...
km.c <- survfit(Surv(t, event) ~1,
                     data = ipd.c)
p.km.c <- km_plot(km.c)
ggsave("figs/duration-bsrbr-ipdsurv-corrona-km.pdf",
...
ggsave("figs/duration-bsrbr-ipdsurv-eular-moderate-km-adjusted.pdf",
...
p.km.b.g.adj <- ggplot(dat, aes(x = time/12, y = surv, col = lab)) + 
  geom_line() + xlab("Year") + ylab("Survival") + scale_color_discrete("") +
  theme(legend.position = "bottom")
ggsave("figs/duration-bsrbr-ipdsurv-eular-good-km-adjusted.pdf",
...
write.csv(ic.b.m, "tables/duration-bsrbr-ipdsurv-eular-moderate-ic.csv")
ggsave("figs/duration-bsrbr-ipdsurv-eular-moderate-gengamma.pdf",
       fits.b.m.diag$p.survfits.gg, height = 5, width = 7)
ggsave("figs/duration-bsrbr-ipdsurv-eular-moderate-parametric.pdf",
       fits.b.m.diag$p.survfits, height = 7, width = 10)
ggsave("figs/duration-bsrbr-ipdcumhaz-eular-moderate-parametric.pdf",
...
write.csv(ic.b.m, "tables/duration-bsrbr-ipdsurv-eular-moderate-ic.csv")
ggsave("figs/duration-bsrbr-ipdsurv-eular-good-gengamma.pdf",
       fits.b.m.diag$p.survfits.gg, height = 5, width = 7)
ggsave("figs/duration-bsrbr-ipdsurv-eular-good-parametric.pdf",
       fits.b.m.diag$p.survfits, height = 7, width = 10)
ggsave("figs/duration-bsrbr-ipdcumhaz-eular-good-parametric.pdf",
       fits.b.m.diag$p.cumhazfits, height = 7, width = 10)

# moderate vs. good 
ic.b <- cbind(ic.b.m, ic.b.g)
colnames(ic.b) <- c("AIC (moderate)", "BIC (moderate)", "AIC (good)", "BIC (good)")
write.csv(ic.b, "tables/duration-bsrbr-ipdsurv-eular-ic.csv")

survfit.eular <- survfit_by_eular(fits.b.m, fits.b.g, t = seq(0, 120, 1),
                                        dist = "gengamma")
ggsave("figs/duration-bsrbr-ipdsurv-gengamma-by-eular.pdf",
...
write.csv(ic.b.m.adj, "tables/duration-bsrbr-ipdsurv-eular-moderate-adjusted-ic.csv")
ggsave("figs/duration-bsrbr-ipdsurv-eular-moderate-gengamma-adjusted.pdf",
       fits.b.m.adj.diag$p.survfits.gg, height = 5, width = 7)
ggsave("figs/duration-bsrbr-ipdsurv-eular-moderate-adjusted-parametric.pdf",
       fits.b.m.adj.diag$p.survfits, height = 7, width = 10)
ggsave("figs/duration-bsrbr-ipdcumhaz-eular-moderate-adjusted-parametric.pdf",
...
write.csv(ic.b.g.adj, "tables/duration-bsrbr-ipdsurv-eular-good-adjusted-ic.csv")
ggsave("figs/duration-bsrbr-ipdsurv-eular-good-gengamma-adjusted.pdf",
       fits.b.g.adj.diag$p.survfits.gg, height = 5, width = 7)
ggsave("figs/duration-bsrbr-ipdsurv-eular-good-adjusted-parametric.pdf",
       fits.b.g.adj.diag$p.survfits, height = 7, width = 10)
ggsave("figs/duration-bsrbr-ipdcumhaz-eular-good-adjusted-parametric.pdf",
...
write.csv(ic.b.adj, "tables/duration-bsrbr-ipdsurv-eular-adjusted-ic.csv")

survfit.eular.adj <- survfit_by_eular(fits.b.m.adj, fits.b.g.adj, t = seq(0, 120, 1),
                                        dist = "gengamma")
ggsave("figs/duration-bsrbr-ipdsurv-adjusted-gengamma-by-eular.pdf",
...
ggsave("figs/duration-bsrbr-ipdsurv-comp-gengamma-by-eular.pdf",
       p.survfit.eular.comp, height = 7, width = 10)

# SAVE PARAMETERS FOR MODEL ----------------------------------------------------
# moderate responders
dur.eular.mod <- dur.eular.good <- dur.eular.mod.adj <- dur.eular.good.adj <- list()
for (i in 1:length(mods)){
  dur.eular.mod[[mods[i]]] <- flexsurvreg_pars(fits.b.m[[mods[i]]])
  dur.eular.good[[mods[i]]] <- flexsurvreg_pars(fits.b.g[[mods[i]]])
  dur.eular.mod.adj[[mods[i]]] <- flexsurvreg_pars(fits.b.m.adj[[mods[i]]])
  dur.eular.good.adj[[mods[i]]] <- flexsurvreg_pars(fits.b.g.adj[[mods[i]]])
}

# SAVE PARAMETERS --------------------------------------------------------------
save(dur.eular.mod, dur.eular.good, dur.eular.mod.adj, dur.eular.good.adj, 
     file = "../data/duration-eular-pars.rda", compress = "bzip2")
