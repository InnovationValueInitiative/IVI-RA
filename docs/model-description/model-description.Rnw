...
\thanks{We thank Darius Lakdawalla, Jason Shafrin, Mark Linthicum, Thanh Ton, Jeffrey Curtis, Carole Wiedmeyer, and members of the Innovation and Value Initiative's scientific advisory panel for reviewing this document. In addition, we thank Sam Norton for help with the latent class growth model.} 
...
tx.snames <- c("cdmards", "abtivmtx", "adamtx", "etnmtx", "golmtx", "ifxmtx", "tczmtx", "czpmtx", "abtscmtx", "rtxmtx", "tofmtx")
nsims <- 1000
...
tx.names <- c("cDMARDs or NBT", "bDMARDs")
...
si1.mtx <- si.prop[dur_dist == "Generalized gamma" & txseq == "cDMARDs or NBT",
                   si_mean]
si1.bio <- si.prop[dur_dist == "Generalized gamma" & txseq == "bDMARDs",
                   si_mean]
