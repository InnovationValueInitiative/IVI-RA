...
sim6_summary <- function(arms, arm_names, nouter = 1000, ninner = 1000, treat_hist = "naive",
  ...
  for (i in 1:length(arms)){
    if (!(model_structure["itreat_switch"] == "das28-switch" & 
...
# simulate
## H1
mod.struct <- select_model_structure(itreat_haq = "acr-haq", itreat_switch = "acr-switch",
                                     utility_model = "wailoo")
sim6.acr2haq.naive <- sim6_summary(arm.snames, arm.names, treat_hist = "naive", 
                                   model_structure = mod.struct)

## H2
mod.struct <- select_model_structure(itreat_haq = "haq", itreat_switch = "das28-switch",
                                     utility_model = "wailoo")
...
util.dt <- data.table(util = c(util.mix$utility, util.wailoo), haq = rep(simhaq$haq, 2),
