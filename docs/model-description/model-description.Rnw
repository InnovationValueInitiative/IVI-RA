...
\begin{itemize}
\item Biologics as monotherapy or in combination with cDMARDs (adalimumab, certolizumab pegol, etanercept, golimumab, infliximab, abatacept, rituximab, tocilizumab, tofacitinib)
...
The evidence network is presented in \autoref{fig:nma-network-acr-naive}. More details about the inclusion criteria to come...
