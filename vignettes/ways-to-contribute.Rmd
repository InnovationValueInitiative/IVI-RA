...
1. You can comment on the scientific approach or evidence considered at [url]. IVI and a technical panel will review the comments and determine whether they should be incorporated into the model. A sythesis of the comments we have received can be found [here](suggested-improvements.html). 
...
- **Patch**: A patch is a bug fix without any significant new features (e.g., `1.0.2`).
