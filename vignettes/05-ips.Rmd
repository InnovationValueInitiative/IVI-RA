...
## Generate input data
Data inputs are model inputs that are fixed at baseline. Given a patient population and model strucutre, we can generate the required data with the function `get_input_data`
