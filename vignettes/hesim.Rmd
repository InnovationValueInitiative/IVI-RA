...
`hesim` is an R package for health economic simulation modeling and decision analysis. More infromation about `hesim` can be found on the package [website](https://hesim-dev.github.io/hesim/).
