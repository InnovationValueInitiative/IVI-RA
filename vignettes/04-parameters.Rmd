...
The information needed to sample from the mixture model are stored in the list `iviRA::utility.mixture`. The setup is the same as with the LCGM in that the list contains a table of coefficient estimates as well as the correspoding variance covariance matrix. 
