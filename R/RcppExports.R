...
#' @export
durationC <- function(x, loc_mod, anc1_mod, loc_good, anc1_good, type, dist, cycle_length, si_duration, anc2_mod = 0.0, anc2_good = 0.0) {
    .Call('iviRA_durationC', PACKAGE = 'iviRA', x, loc_mod, anc1_mod, loc_good, anc1_good, type, dist, cycle_length, si_duration, anc2_mod, anc2_good)
}
